...
public class WorldContactListener implements ContactListener {
    ...
    public void beginContact(Contact contact) {
        ...
        switch (cDef) {
            ...
            case MarioBros.ENEMY_HEAD_BIT | MarioBros.GROUND_BIT:
                if ((fixA.getFilterData().categoryBits != MarioBros.OBJECT_BIT) && (fixA.getFilterData().categoryBits != MarioBros.GROUND_BIT))
            ...
            case MarioBros.ENEMY_BIT | MarioBros.ENEMY_HEAD_BIT:
